...
bool StatusH = false, Counttime = false, StatusF = false, StatusC = false, StatusA = false;
DS1302 rtc(2, 0, 4);
void setup(){
  rtc.halt(false);
...
void loop(){
  ...
  if (key != NO_KEY && Modeset == 2 && StatusA == false && (key == '1' || key == '2' ||
  key == '3' || key == '4' || key == '5' || key == '6' || key == '7' || key == '8' || key == '9' ||
  key == '0')) {
    Settimer = Settimer + key;
    Min = Settimer.toInt();
  ...
  if (key != NO_KEY && Modeset == 5 && StatusA == false && (key == '1' || key == '2' ||
  key == '3' || key == '4' || key == '5' || key == '6' || key == '7' || key == '8' || key == '9' ||
  key == '0')) {
    Settimer = Settimer + key;
    Mon = Settimer.toInt();
