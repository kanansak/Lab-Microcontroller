int sw1 =13; //รับค่าสวิตซ์sw1 เป็นสวิตช์ใช้กดเพื่อเปลี่ยนโหมดเป็นAutoหรือManual
int sw2 =12; //รับค่าสวิตซ์sw2 เป็นสวิตช์ใช้กดเพื่อเลือกสถานะของสีไปจราจร
int sw3 = 27;
int sw4 = 26;
...
int inputsw3 = 1;
int inputsw4 = 1;
int LED_Red1 =2; //ออกขา1สีแดง
int LED_Y1 =0; // ออกขา2สีเหลือง
int LED_G1 =4; //ออกขา3สีเขียว
int LED_Red2 =16; //ออกขา4สีแดง
int LED_Y2 =17; // ออกขา5สีเหลือง
int LED_G2 =5; //ออกขา6สีเขียว
int LED_R3 =18; //ออกขา7สีแดง
int LED_Y3 =19; // ออกขา8สีเหลือง
int LED_G3 =21; //ออกขา9สีเขียว
...
void loop() {
  ...
  if(inputsw2==4){ //เป็นการกดสวิตซ์ตัวที่สองแบบMANUALและถ้ากดเกินเป็น7ครั้งจะทำการ
   inputsw2=1;
   Serial.println("SW2 > " );
   Serial.println(inputsw2);
   }
  //เช็คค่าเกินกว่าที่ระบุ//
  if(inputsw3==4){
    inputsw3=1;
    Serial.print("SW3 > " );
    Serial.println(inputsw3);
    }
  
   if(inputsw4==4){
    inputsw4=1;
    Serial.print("SW4 > " );
    Serial.println(inputsw4);
    }
}
void LEDAUTO() {
